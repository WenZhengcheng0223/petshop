...
public class OrderController extends BaseController {
     ...
     */
    @ApiOperation("查询订单列表")
    @SaCheckPermission("petshop:order:list")
    @GetMapping("/list")
     ...
     */
    @ApiOperation("导出订单列表")
    @SaCheckPermission("petshop:order:export")
    ...
    @SaCheckPermission("petshop:order:query")
    @GetMapping("/{orderId}")
    public R<OrderVo> getInfo(@ApiParam("主键")
                                                  @NotNull(message = "主键不能为空")
                                                  @PathVariable("orderId") String orderId) {
        return R.ok(iOrderService.queryById(orderId));
    }
     ...
     */
    @ApiOperation("新增订单")
    @SaCheckPermission("petshop:order:add")
     ...
     */
    @ApiOperation("修改订单")
    @SaCheckPermission("petshop:order:edit")
     ...
     */
    @ApiOperation("删除订单")
    @SaCheckPermission("petshop:order:remove")
